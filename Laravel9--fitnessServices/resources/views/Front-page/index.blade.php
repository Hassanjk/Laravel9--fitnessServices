...
@section('content')
    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <img class="img-fluid mb-4 mb-lg-0" src="{{asset('assets')}}/img/about.jpg" alt="Image">
            </div>
            <div class="col-lg-6">
    ...
    <div class="container feature pt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-5">
                <div class="row align-items-center">
                    <div class="col-sm-5">
                        <img class="img-fluid mb-3 mb-sm-0" src="{{asset('assets')}}/img/feature-2.jpg" alt="Image">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-lg m-0">
                            ...
                            <tr>
                                ...
                                <td><h5>Crossfit</h5>Adam Phillips</td>
                                <td></td>
                                <td class="bg-primary text-white"><h5 class="text-white">Power Lifting</h5>James Alien
                                </td>
                                <td></td>
                                <td><h5>Cardio</h5>John Deo</td>
                            </tr>
    ...
    <div class="container pt-5 team">
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-primary font-weight-bold">Our Packages</h4>
            <h4 class="display-4 font-weight-bold">subscribe to the best packages available</h4>
        </div>
        <div class="row">
                        ...
                        <div id="carouselId" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <div class="d-flex align-items-center mb-4 text-white">
                                        <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                             src="{{asset('assets')}}/img/testimonial-1.jpg" alt="Image">
                                        <div class="pl-4">
                                ...
                                <div class="carousel-item">
                                    <div class="d-flex align-items-center mb-4 text-white">
                                        <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                             src="{{asset('assets')}}/img/testimonial-2.jpg" alt="Image">
                                        <div class="pl-4">
                                            <h4 class="text-primary">Client Name</h4>
                                            <p class="m-0">Profession</p>
                                        </div>
                                ...
                                <div class="carousel-item">
                                    <div class="d-flex align-items-center mb-4 text-white">
                                        <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                             src="{{asset('assets')}}/img/testimonial-3.jpg" alt="Image">
                                        <div class="pl-4">
                                            <h4 class="text-primary">Client Name</h4>
                                            <p class="m-0">Profession</p>
                                        </div>
